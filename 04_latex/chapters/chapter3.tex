...
The cross-country results (Part~B) show that the Ridge approach is not France-specific but generalises robustly across the four largest Euro-area economies.  RMSE improvements of~13--20\% are achieved with essentially the same model specification and data sources, suggesting that a centralised ECB nowcasting system for Euro-area current accounts is feasible.
