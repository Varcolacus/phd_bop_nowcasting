...
We apply the \citet{hansen2011model} MCS procedure at the~10\% level across all specification$\times$model combinations (M0--M5 evaluated with AR(1), Ridge, and XGBoost---18 candidates in total).  All 18 candidates survive, reflecting the limited power of the MCS with 84 evaluation observations.  However, the elimination order ranks M5~Ridge first and M4~AR(1) last, consistent with the pairwise test results.
