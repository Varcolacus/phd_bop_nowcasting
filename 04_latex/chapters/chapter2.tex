...
\caption{SHAP importance decomposition by data category for the M5 (Full) model.  Conventional macro predictors account for~63\% of forecast variation; text/sentiment data provide the largest alternative data contribution (17\%).}
\label{fig:ch2_shap}
\end{figure}
