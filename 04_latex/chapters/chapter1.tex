...
Applying the \citet{hansen2011model} Model Confidence Set (MCS) procedure at the~10\% significance level, all nine models survive---none is eliminated.  This result reflects the small evaluation sample ($T = 51$ quarters): the MCS procedure is conservative with limited data.  The MCS does, however, rank Ridge as the top model and LSTM/GRU at the bottom of the surviving set.
