...
\textbf{Chapter~3} bridged accuracy and policy relevance through three exercises.  Crisis evaluation showed Ridge maintained a~17\% RMSE reduction during COVID-19, precisely when timely information was most valuable.  Cross-country tests confirmed generalisability: \textbf{13--20\% improvements for Germany, Italy, and Spain}.  A BoP-augmented Taylor rule estimated $\hat{\delta} = -0.481$ ($p = 0.003$), implying that \textbf{more accurate BoP nowcasts would have shifted implied policy rates by up to~159.7 basis points} at peak episodes.
